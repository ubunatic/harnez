...
| 130 | [archive/130-instruction-distribution-audit-followups.md](archive/130-instruction-distribution-audit-followups.md) | Instruction-distribution audit follow-ups (Tool Feedback Protocol misscoping, doc-index accuracy, delivery duplication, Skill infra) | Closed — resolved in (pending commit) |
