...
| 109 | [109-user-local-config-xdg-config-harnez-local-yaml.md](109-user-local-config-xdg-config-harnez-local-yaml.md) | User-local config: `~/.config/harnez/local.yaml` for machine-static overrides (default host, future caches) | Open |
