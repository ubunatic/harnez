...
| [studies/2026-09-17-doc-screenshots-and-vision-token-efficiency-benchmark.md](studies/2026-09-17-doc-screenshots-and-vision-token-efficiency-benchmark.md) | Claude (`claude`), Antigravity/Gemini (`agy`), OpenAI/Codex (Theoretical & Architecture) |
