...
| [studies/2026-09-04-fleet-wide-24h-cross-project-survey.md](studies/2026-09-04-fleet-wide-24h-cross-project-survey.md) | Meta-survey across `harnez`, `ubunatic.com`, `lmcoder`, `voxi`, `uman`, `psync` (95 commits/24h) assembled from git/issue history rather than a single session; `smarthome` left as a placeholder for its own in-progress story |
