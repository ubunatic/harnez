...
| [ModelResearch.md](ModelResearch.md) | Repeatable web-research plan for model guidance: triggers, id check, one researcher per column (COST, EFF, Go, TUI, SQL), reconcile, spec/snapshot update, cleanup (consult when a new model arrives or prices change) |
