...
| [studies/2026-08-31-bar-rendering-visual-debugging-and-spec-bootstrap.md](studies/2026-08-31-bar-rendering-visual-debugging-and-spec-bootstrap.md) | `--watch` collector parallelization (129), hotkey overhaul + first `spec/` bootstrap (132), debug overlay (131), and a four-round screenshot-driven bar-color debugging chain (133/136/137/138) — the `rograph` package-boundary rule, and a byte-vs-rune test bug the fix exposed |
