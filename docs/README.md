...
| [ModelResearch.md](ModelResearch.md) | Repeatable model research plan: triggers, id check, column-wise web research, skill canaries, spec/snapshot update, cleanup (consult when a new model arrives or prices change) |
