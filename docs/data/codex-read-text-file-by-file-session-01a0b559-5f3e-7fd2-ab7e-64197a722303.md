...
I’ll inspect the project-local overrides and the Makefile guidance, then read the Makefile.

## Activity

    $ /usr/bin/zsh -lc "⚙ bash -c 'test -f AGENTS.local.md && sed -n '\\''1,240p'\\'' AGENTS.local.md; sed -n '\\''1,240p'\\'' docs/Make.md; sed -n '\\''1,260p'\\'' Makefile'"
...
[Makefile](/home/uwe/projects/harnez/Makefile) read.

It defines build, install, apply/init, checks, smoke tests, release, sync, and Quota-1 testing targets.
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ bash -c 'rg --files docs/lang -g '\\''*.md'\\'' -g '\\''"'!**/*/*'"'\\'' | sort'"
    status: Completed · exit 0

## Activity

    $ /usr/bin/zsh -lc "⚙ bash -c 'rg --files docs/lang -g '\\''*.md'\\'' | awk '\\''BEGIN { prefix=\"docs/lang/\" } index("'$0, prefix)==1 && substr($0, length(prefix)+1) !~ /'"\\// { print }'\\'' | sort'"
    status: Completed · exit 0
...
Non-recursive `.md` files in `docs/lang`:
...
I’ll read the 12 files individually, keeping each read separate, then summarize each in one sentence.

## Activity

    $ /usr/bin/zsh -lc "⚙ sed -n '1,260p' docs/lang/Bash.lite.md"
    status: Completed · exit 0
      <!-- harnez:variant=lite -->
      # Bash Rules (Lite)
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,260p' docs/lang/Bash.md"
    status: Completed · exit 0
      ---
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,260p' docs/lang/Cpp.md"
    status: Completed · exit 0
      ---
      title: C++ Conventions
      weight: 66
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,260p' docs/lang/GTK4.md"
    status: Completed · exit 0
      ---
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,320p' docs/lang/Make.lite.md"
    status: Completed · exit 0
      <!-- harnez:variant=lite -->
      # Make Rules (Lite)
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,320p' docs/lang/Git.md"
    status: Completed · exit 0
      ---
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,320p' docs/lang/Go.md"
    status: Completed · exit 0
      ---
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,320p' docs/lang/Make.md"
    status: Completed · exit 0
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,320p' docs/lang/ManPages.md"
    status: Completed · exit 0
      ---
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,320p' docs/lang/Rust.md"
    status: Completed · exit 0
      ---
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,320p' docs/lang/Zig.md"
    status: Completed · exit 0
      ---
...
## Activity
    ...
    $ /usr/bin/zsh -lc "⚙ sed -n '1,320p' docs/lang/Markdown.md"
    status: Completed · exit 0
      ---
...
- [Bash.lite.md](/home/uwe/projects/harnez/docs/lang/Bash.lite.md): Defines concise Bash rules for strict mode, explicit sourcing, `test` conditionals, quoting, safe commands, traps, directory scoping, and mawk portability.
- [Bash.md](/home/uwe/projects/harnez/docs/lang/Bash.md): Provides the full Bash conventions with detailed examples for conditionals, variables, output, continuations, timeouts, traps, functions, and safe directory handling.
- [Cpp.md](/home/uwe/projects/harnez/docs/lang/Cpp.md): Recommends ccache, serialized CGO/Qt builds, and constrained Go memory settings for C/C++-integrated builds.
- [GTK4.md](/home/uwe/projects/harnez/docs/lang/GTK4.md): Documents PyGObject/GTK4 practices for application uniqueness, unified gesture handling, correctly sized Cairo overlays, and integration smoke tests.
- [Git.md](/home/uwe/projects/harnez/docs/lang/Git.md): Establishes default-branch workflows, proactive conventional commits, review expectations, repository hygiene, and restrictions on pushing or using mirrors.
- [Go.md](/home/uwe/projects/harnez/docs/lang/Go.md): Specifies modern, dependency-light Go practices covering project structure, workspaces, specs, Cobra CLIs, error handling, state management, terminal text, and table-driven tests.
- [Make.lite.md](/home/uwe/projects/harnez/docs/lang/Make.lite.md): Summarizes Makefile conventions for help-first targets, sentinel-based phony rules, builds, installs, checks, and transparent deployment targets.
- [Make.md](/home/uwe/projects/harnez/docs/lang/Make.md): Fully explains self-documenting Makefiles, sentinel phony targets, dependency ordering, local binary execution, installation, verification, and deployment parity.
- [ManPages.md](/home/uwe/projects/harnez/docs/lang/ManPages.md): Describes implementing Cobra-generated man pages with stdout and self-installation workflows, correct user/system paths, Makefile integration, and packaging.
- [Markdown.md](/home/uwe/projects/harnez/docs/lang/Markdown.md): Defines naming and content conventions for evergreen and ephemeral Markdown documents plus hyperlink and diagram practices.
- [Rust.md](/home/uwe/projects/harnez/docs/lang/Rust.md): Sets Rust standards for stable tooling, minimal dependencies, safe error handling, project layout, testing, and documented `unsafe` code.
- [Zig.md](/home/uwe/projects/harnez/docs/lang/Zig.md): Establishes explicit-allocation and low-resource Zig practices while cataloging Zig 0.16.0 API pitfalls and workarounds.
...
## Activity
    ...
    status: Completed · exit 0
      TOOL  CALLS  AVG SCORE  AVG TOKENS  SAVINGS TOKENS  SAVINGS BYTES  FAILURE RATE
      Bash  15     n/a        20817.5     -               -              0.0%
      sed   12     4.67       20064.7     -               -              8.3%
      rg    2      5.00       17503.0     -               -              0.0%
      test  1      5.00       n/a         -               -              0.0%
      
      AGENT  CALLS  AVG SCORE  AVG TOKENS  SAVINGS TOKENS  SAVINGS BYTES  FAILURE RATE
      codex  30     4.73       20294.7     -               -              3.3%
      
      PROJECT  CALLS  AVG SCORE  AVG TOKENS  SAVINGS TOKENS  SAVINGS BYTES  FAILURE RATE
      harnez   30     4.73       20294.7     -               -              3.3%
